...
/**
 * A class to parse a JSP template by using {@link JspVariableExtractor}.
 * 
 * @author Kazunori Sakamoto
 */
public class JspParser extends TemplateParser {
  /**
   ...
   *        variables
   */
  public JspParser(String attributeName) {
    super(attributeName);
  }
  ...
  protected List<HtmlTagInfo> parseTagsContainingVariables(String template)
    ...
    JspVariableExtractor extractor =
        new JspVariableExtractor(new RangeSet<Integer>(), attributeName);
    try {
