...
/**
 * A class to parse a Groovy template by using {@link GroovyTemplateVariableExtractor}.
 * 
 * @author Kazunori Sakamoto
 */
public class GroovyTemplateParser extends TemplateParser {
  /**
   ...
   *        variables
   */
  public GroovyTemplateParser(String attributeName) {
    super(attributeName);
  }
