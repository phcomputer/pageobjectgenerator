...
/**
 * A utility class to measure template-variable coverage from the specified {@link TemplateInfo}
 * instance.
 * 
...
public class VariableCoverageMeasurer {
  ...
  /**
   * Measures template-variable coverage from the specified {@link TemplateInfo} instance. Note that
   * same template variables in other html tags count as other template variables.
   * 
   * @param templateInfo the {@link TemplateInfo} instance to be measured
   * @return the {@link VariableCoverage} instance which stores the measurement result
   */
