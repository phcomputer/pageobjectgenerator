...
/**
 * This class encapsulates a processing-file error condition that occurred while processing for
 * propagating errors in the main method.
 * 
 * @author Kazunori Sakamoto
 */
public class FileProcessException extends IOException {

  private static final long serialVersionUID = 179806011921339398L;

  /**
   * Constructs a processing-file exception with the specified file and the specified detail message
   * without period.
   * 
  ...
  /**
   * Constructs a processing-file exception with the specified file and the specified detail message
   * without period and the supplied {@link Exception}.
   * 
   * @param message the string to describe the detail message without period
   * @param file the file that caused the error
