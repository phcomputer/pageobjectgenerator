...
/**
 * This class encapsulates a test-code-updating related error condition that
 * occurred while generating skeleton test code designed by PageObject pattern.
 *
...
public class PageObjectUpdateException extends Exception {
  ...
  /**
   * Construct a test-code-updating exception chaining the supplied
   * {@link Exception}.
   *
