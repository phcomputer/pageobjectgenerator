...
public class TestCodeGeneratorWithoutClassAttributeTest {
	...
	private static final String CLASS_HEAD = "public class TestPage extends AbstractPage {\n"
	...
	private static final String HEAD = "package ;\n\n"
	...
	public void generateForAnEnclosure() throws TemplateParseException {
		TemplateInfo templateInfo = parser
	...
	public void generateForAnEnclosure2() throws TemplateParseException {
		TemplateInfo templateInfo = parser
				.parse("<html><body>{$content}</body></html>");
		updater.generate(templateInfo);
		String actual = generator.generate(templateInfo, "", "Test");
		String expected = HEAD
				+ "  @FindBy(how = How.XPATH, using = \"//*[@id='_0']\")\n"
	...
	@Test
	public void generateForAnEnclosureUsingProhibittedChars()
	...
	@Test
	public void generateForAnEnclosureUsingOption()
			throws TemplateParseException {
		TemplateInfo templateInfo = parser
	...
	@Test
	public void generateForAnEnclosureContainingTwoDiffVars()
			throws TemplateParseException {
		TemplateInfo templateInfo = parser
				.parse("<html><body>{$content1}{$content2}</body></html>");
		updater.generate(templateInfo);
		String actual = generator.generate(templateInfo, "", "Test");
		String expected = HEAD
				+ "  @FindBy(how = How.XPATH, using = \"//*[@id='_0']\")\n"
	...
	@Test
	public void generateForAnEnclosureContainingTwoSameVars()
			throws TemplateParseException {
		TemplateInfo templateInfo = parser
				.parse("<html><body>{$content}{$content}</body></html>");
		updater.generate(templateInfo);
		String actual = generator.generate(templateInfo, "", "Test");
		String expected = HEAD
				+ "  @FindBy(how = How.XPATH, using = \"//*[@id='_0']\")\n"
	...
	@Test
	public void generateForTwoEnclosuresContainingSameVars()
			throws TemplateParseException {
		TemplateInfo templateInfo = parser
				.parse("<html><body><p>{$content}<p>{$content}</body></html>");
		updater.generate(templateInfo);
		String actual = generator.generate(templateInfo, "", "Test");
		String expected = HEAD
				+ "  @FindBy(how = How.XPATH, using = \"//*[@id='_0']\")\n"
	...
	public void generateForEnclosuresContainingTwoVarsWithTextAndAttr()
			throws TemplateParseException {
		TemplateInfo templateInfo = parser
				.parse("<html><body attr='{$content1}'>{$content2}</body></html>");
		updater.generate(templateInfo);
		String actual = generator.generate(templateInfo, "", "Test");
		String expected = HEAD
				+ "  @FindBy(how = How.XPATH, using = \"//*[@id='_0']\")\n"
	...
	public void generateForDistantEnclosures() throws TemplateParseException {
		TemplateInfo templateInfo = parser
				.parse("<html><body><p></p>{$content}</body></html>");
		updater.generate(templateInfo);
		String actual = generator.generate(templateInfo, "", "Test");
		String expected = HEAD
				+ "  @FindBy(how = How.XPATH, using = \"//*[@id='_0']\")\n"
	...
	public void treatExistingId() throws TemplateParseException {
		TemplateInfo templateInfo = parser
				.parse("<html><body id='content'><p></p>{$content}</body></html>");
		updater.generate(templateInfo);
		String actual = generator.generate(templateInfo, "", "Test");
		String expected = HEAD
	...
	public void treatExistingId2() throws TemplateParseException {
		TemplateInfo templateInfo = parser
				.parse("<html><body id='content'><p></p><p>{$content}</p></body></html>");
		updater.generate(templateInfo);
		String actual = generator.generate(templateInfo, "", "Test");
		String expected = HEAD
				+ "  @FindBy(how = How.XPATH, using = \"//*[@id='_0']\")\n"
	...
	public void treatConflictedVariableNames() throws TemplateParseException {
		TemplateInfo templateInfo = parser
				.parse("<html><p>{$content}</p><p>{$content}{$content2}</p></body></html>");
		updater.generate(templateInfo);
		String actual = generator.generate(templateInfo, "", "Test");
	...
	public void treatVariableInAttribute() throws TemplateParseException {
		TemplateInfo templateInfo = parser
				.parse("<html><body><a href='{$url}'></a></body></html>");
		updater.generate(templateInfo);
		String actual = generator.generate(templateInfo, "", "Test");
		String expected = HEAD
				+ "  @FindBy(how = How.XPATH, using = \"//*[@id='_0']\")\n"
	...
	public void treatVariableInAttributeAndText() throws TemplateParseException {
		TemplateInfo templateInfo = parser
				.parse("<html><body><a href='{$url}'>{$url}</a></body></html>");
		updater.generate(templateInfo);
		String actual = generator.generate(templateInfo, "", "Test");
		String expected = HEAD
				+ "  @FindBy(how = How.XPATH, using = \"//*[@id='_0']\")\n"
	...
	public void treatExcludedPart() throws TemplateParseException {
		TemplateInfo templateInfo = parser
				.parse("<html>{call .t1}{$v1}{/call}<a>{$v2}</a></html>");
		updater.generate(templateInfo);
		String actual = generator.generate(templateInfo, "", "Test");
		String expected = HEAD
				+ "  @FindBy(how = How.XPATH, using = \"//*[@id='_0']\")\n"
